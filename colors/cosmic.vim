...
"  Palette : https://github.com/gerardbm/cosmic
"----------------------------------------------------------------
...
if (has('termguicolors') && &termguicolors) || has('gui_running')
	...
	if exists('g:cosmic_mode')
		let s:mode = g:cosmic_mode
	else
		let s:mode = 1
	endif
	...
	if s:mode == 1
		" Lunar C1
		" -----------------------
		let s:base1 = '#00090D' " L* 2%
		let s:base2 = '#011319' " L* 5%
	elseif s:mode == 2
		" Lunar C2
		" -----------------------
		let s:base1 = '#011016' " L* 4%
		let s:base2 = '#01181F' " L* 7%
	elseif s:mode == 3
		" Lunar C3
		" -----------------------
		let s:base1 = '#01161D' " L* 6%
		let s:base2 = '#021D25' " L* 9%
	elseif s:mode == 4
		" Lunar C4
		" -----------------------
		let s:base1 = '#021A22' " L* 8%
		let s:base2 = '#02212A' " L* 11%
	elseif s:mode == 5
		" Lunar C5
		" -----------------------
		let s:base1 = '#021F27' " L* 10%
		let s:base2 = '#03252F' " L* 13%
	elseif s:mode == 6
		" Solar C6
		" -----------------------
		let s:base1 = '#FCF9F5' " L* 98%
		let s:base2 = '#F9EFE5' " L* 95%
	elseif s:mode == 7
		" Solar C7
		" -----------------------
		let s:base1 = '#FAF2EB' " L* 96%
		let s:base2 = '#F6E9DB' " L* 93%
	elseif s:mode == 8
		" Solar C8
		" -----------------------
		let s:base1 = '#F8ECE0' " L* 94%
		let s:base2 = '#F4E3CF' " L* 91%
	elseif s:mode == 9
		" Solar C9
		" -----------------------
		let s:base1 = '#F5E6D5' " L* 92%
		let s:base2 = '#F2DCC4' " L* 89%
	elseif s:mode == 0
		" Solar C0
		" -----------------------
		let s:base1 = '#F3DFCA' " L* 90%
		let s:base2 = '#F0D6B7' " L* 87%
	endif

	" Base colors 3 & 4
	" -----------------------
	if s:mode == 1 || s:mode == 2 || s:mode == 3 || s:mode == 4 || s:mode == 5
		" Lunar
		" -----------------------
		let s:base3 = '#79849A' " L* 55%
		let s:base4 = '#AFB3BE' " L* 73%
	elseif s:mode == 6 || s:mode == 7 || s:mode == 8 || s:mode == 9 || s:mode == 0
		" Solar
		" -----------------------
	...
	if s:mode >= 1 && s:mode <= 5
		...
		" -----------------------
		" Base 3 & 4
		let s:base3 = '#78868D' " | L* 55%
		let s:base4 = '#ACB5B9' " | L* 73%
		...
		" -----------------------
		" Base 3 & 4
		let s:base3 = '#6D645A' " | L* 43%
		let s:base4 = '#3E3B38' " | L* 25%
	...
	" Commands
	command! CosmicLunarC1        let g:cosmic_mode = 1 | set background=dark
				\ | colorscheme cosmic
	command! CosmicLunarC2        let g:cosmic_mode = 2 | set background=dark
				\ | colorscheme cosmic
	command! CosmicLunarC3        let g:cosmic_mode = 3 | set background=dark
				\ | colorscheme cosmic
	command! CosmicLunarC4        let g:cosmic_mode = 4 | set background=dark
				\ | colorscheme cosmic
	command! CosmicLunarC5        let g:cosmic_mode = 5 | set background=dark
				\ | colorscheme cosmic

	command! CosmicSolarC6        let g:cosmic_mode = 6 | set background=light
				\ | colorscheme cosmic
	command! CosmicSolarC7        let g:cosmic_mode = 7 | set background=light
				\ | colorscheme cosmic
	command! CosmicSolarC8        let g:cosmic_mode = 8 | set background=light
				\ | colorscheme cosmic
	command! CosmicSolarC9        let g:cosmic_mode = 9 | set background=light
				\ | colorscheme cosmic
	command! CosmicSolarC0        let g:cosmic_mode = 0 | set background=light
				\ | colorscheme cosmic

	function! CycleModes()
		let s:cycle = g:cosmic_mode
...
" italic
if exists('g:cosmic_italic')
	let g:cosmic_italic = g:cosmic_italic
else
	let g:cosmic_italic = 1
endif

let s:itl = 'italic'
if g:cosmic_italic == 0
	let s:itl = 'NONE'
endif

" bold
if exists('g:cosmic_bold')
	let g:cosmic_bold = g:cosmic_bold
else
	let g:cosmic_bold = 1
endif
...
" underline
if exists('g:cosmic_underline')
	let g:cosmic_underline = g:cosmic_underline
else
	let g:cosmic_underline = 1
endif

let s:unl = 'underline'
if g:cosmic_underline == 0
	let s:unl = 'NONE'
endif

" undercurl
if exists('g:cosmic_undercurl')
	let g:cosmic_undercurl = g:cosmic_undercurl
else
	let g:cosmic_undercurl = 1
endif

let s:unc = 'undercurl'
if g:cosmic_undercurl == 0
	let s:unc = 'NONE'
endif

" matchparen
if exists('g:cosmic_matchparen')
	let g:cosmic_matchparen = g:cosmic_matchparen
else
	let g:cosmic_matchparen = 1
endif

if g:cosmic_matchparen == 0
	let s:mpb = 'NONE'
	let s:mpf = s:aco50
else
	let s:mpb = s:aco50
...
execute 'hi fugitiveHelpHeader '        . s:envir . 'fg=' . s:aco70 . ' ' . s:envir . 'bg=' . s:non . ' gui=' . s:non . ' cterm=' . s:non
execute 'hi fugitiveHeader     '        . s:envir . 'fg=' . s:aco70 . ' ' . s:envir . 'bg=' . s:non . ' gui=' . s:non . ' cterm=' . s:non
execute 'hi fugitiveHeading    '        . s:envir . 'fg=' . s:aco70 . ' ' . s:envir . 'bg=' . s:non . ' gui=' . s:non . ' cterm=' . s:non
execute 'hi fugitiveUntrackedModifier ' . s:envir . 'fg=' . s:acv50 . ' ' . s:envir . 'bg=' . s:non . ' gui=' . s:non . ' cterm=' . s:non
execute 'hi fugitiveUnstagedModifier '  . s:envir . 'fg=' . s:acr50 . ' ' . s:envir . 'bg=' . s:non . ' gui=' . s:non . ' cterm=' . s:non
execute 'hi fugitiveStagedModifier '    . s:envir . 'fg=' . s:acg50 . ' ' . s:envir . 'bg=' . s:non . ' gui=' . s:non . ' cterm=' . s:non
...
execute 'hi csvCol0 ' . s:envir . 'fg=' . s:acc50 . ' ' . s:envir . 'bg=' . s:non . ' gui=' . s:non . ' cterm=' . s:non
execute 'hi csvCol1 ' . s:envir . 'fg=' . s:acb50 . ' ' . s:envir . 'bg=' . s:non . ' gui=' . s:non . ' cterm=' . s:non
execute 'hi csvCol2 ' . s:envir . 'fg=' . s:acg50 . ' ' . s:envir . 'bg=' . s:non . ' gui=' . s:non . ' cterm=' . s:non
execute 'hi csvCol3 ' . s:envir . 'fg=' . s:acc50 . ' ' . s:envir . 'bg=' . s:non . ' gui=' . s:non . ' cterm=' . s:non
execute 'hi csvCol4 ' . s:envir . 'fg=' . s:acb50 . ' ' . s:envir . 'bg=' . s:non . ' gui=' . s:non . ' cterm=' . s:non
execute 'hi csvCol5 ' . s:envir . 'fg=' . s:acg50 . ' ' . s:envir . 'bg=' . s:non . ' gui=' . s:non . ' cterm=' . s:non
execute 'hi csvCol6 ' . s:envir . 'fg=' . s:acc50 . ' ' . s:envir . 'bg=' . s:non . ' gui=' . s:non . ' cterm=' . s:non
execute 'hi csvCol7 ' . s:envir . 'fg=' . s:acb50 . ' ' . s:envir . 'bg=' . s:non . ' gui=' . s:non . ' cterm=' . s:non
execute 'hi csvCol8 ' . s:envir . 'fg=' . s:acg50 . ' ' . s:envir . 'bg=' . s:non . ' gui=' . s:non . ' cterm=' . s:non
